import type { HTMLAttributes, IframeHTMLAttributes, ImgHTMLAttributes, MutableRefObject, ReactNode, VideoHTMLAttributes } from "react";
import { ILazyLoadOptions } from "vanilla-lazyload";
export interface LazyElementProps<T extends HTMLElement> extends HTMLAttributes<T> {
