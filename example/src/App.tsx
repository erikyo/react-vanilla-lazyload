import {LazyImg, LazyVideo, LazyIframe, LazyEl, LazyWrapper} from 'react-vanilla-lazyload/lib/index'
...
function App () {
    return (
      <LazyWrapper>
        ...
        <LazyVideo src={'https://verlok.github.io/vanilla-lazyload/demos/videos/1920x1080-01.mp4'} poster={'https://verlok.github.io/vanilla-lazyload/demos/images/440x560-01.webp'} controls={false} />
        <LazyVideo src={'https://verlok.github.io/vanilla-lazyload/demos/videos/1920x1080-0s.mp4'} poster={'https://verlok.github.io/vanilla-lazyload/demos/images/440x560-02.webp'} controls={false} />
        ...
        <LazyEl srcBg={'https://verlok.github.io/vanilla-lazyload/demos/images/440x560-01.webp'} title={'asd'} style={{ width: 500, height: 500, backgroundImage: 'url(https://verlok.github.io/vanilla-lazyload/demos/images/440x560-01.webp)' }} />
